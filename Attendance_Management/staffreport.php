...
else
{
  ...
  $sql = "SELECT S.sid,S.subjectname,S.semester,S.coursecode from subjects S,Faculty F,assign_faculty AF where S.sid=AF.sid and AF.fid=F.fid and F.uname= '$name'";
  ...
  if(mysqli_num_rows($result)>0)
   {
      ...
      {
          echo "<tr><td>". $row["subjectname"]. " </td><td> " . $row["semester"]. "</td><td> " . $row["coursecode"]. "</td></td>";
          $id = $row['sid'];
          echo"<td><a href=staffdetailreport.php?sid={$id}>Details</a></td></tr>";
		}
  } 
  else 
  {
