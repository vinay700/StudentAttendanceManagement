      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="faculty.php">Faculty</a></li>
                        <li class="breadcrumb-item active"> Add Faculty</li>

          </ol>
<form action="addfactprocess.php" method="POST">
  Faculty Name:<input type="text" name="facultyname" required>
  Designation:<input type="text" name="desig" required>
<button type="submit">Add</button>
</form>
<div class="dropdown-divider"></div>
<form action="addallfaculty.php" method="post" enctype="multipart/form-data">
    <div>
        <label>Choose Excel
  ...
  if(mysqli_num_rows($result)>0)
   {
      ...
      {
          echo "<tr><td> " . $row["facultyname"]. " </td><td> " . $row["designation"]. "</td><td> " . $row["uname"]. "</td></tr>" ;
      }
  } 
  else 
  {
