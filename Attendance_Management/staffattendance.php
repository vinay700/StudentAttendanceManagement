...
{
  $sql = "SELECT S.sid,S.subjectname,S.semester,S.coursecode from subjects S,Faculty F,assign_faculty AF where S.sid=AF.sid and AF.fid=F.fid and 
  F.uname= '$name'";
  ...
  if(mysqli_num_rows($result)>0)
   {
      ...
      while($row = mysqli_fetch_assoc($result))
      {
          ...
          $id = $row['sid'];
          echo"<td><a href=takeattendance.php?psid={$id}>Take Attendance</a></td></tr>";
      }
  } 
  else 
  {
