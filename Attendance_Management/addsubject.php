	...
	<div id="content-wrapper">
		...
		<div class="w3-card-4" style="width:15%">
		    ...
		    <div class="w3-container">
		      <hr>
		      <img src="img/add-books-833908.png" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="width:90px">
		      <br>
		    </div>
		   <a href="addtheorysubject.php"> <button class="w3-button w3-block w3-dark-grey">+ Add Theory</button></a>
		 </div>
		 <br>
		  <br>
		 <div class="w3-card-4" style="width:15%">
		    ...
		    <div class="w3-container">
		      <hr>
		      <img src="img/img_532131.png" alt="Avatar"  style="width:90px">
		      <br><br>
		    </div>
		    <a href="addlabsubjects.php"><button class="w3-button w3-block w3-dark-grey"> Add Lab</button></a>
		 </div>
	</div>
	</div>
</div>
